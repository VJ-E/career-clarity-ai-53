  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-primary text-primary-foreground hover:opacity-90 transition-smooth glow-primary",
        hero: "bg-gradient-to-r from-primary/20 to-secondary/20 text-foreground border border-primary/50 hover:border-primary hover:bg-gradient-to-r hover:from-primary/30 hover:to-secondary/30 backdrop-blur-sm transition-smooth",
      },
      size: {
